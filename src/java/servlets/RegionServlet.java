...
//            request.getRequestDispatcher("TampilDataRegion.jsp").forward(request, response);
            response.sendRedirect("TampilDataRegion.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        if (rc.save(request.getParameter("regionId"), request.getParameter("regionName")) != null) {
            processRequest(request, response);
        }
    }
